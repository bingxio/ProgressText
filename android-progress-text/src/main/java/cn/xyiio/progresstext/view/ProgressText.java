...
public class ProgressText extends RelativeLayout {
    ...
    public void setTextAll(String head_text, int start_progress, int end_progress, 
                           String line_text, String bottom_text) {
    ...
    public void setTextSizeAll(float head_size, float start_size, float end_size, 
                               float line_size, float bottom_size) {
